...
const translations = {
  en: {
    ...
    'gallery.mini_camp.description': 'Educational, creative and community activities for children and teenagers during the Agogomé Mini Camp.',
    'gallery.school_kits_davie.description': 'Distribution of school kits to support children and families as the school year begins.',
    'gallery.school_kits_agogome.description': 'School-supply distribution organized for children in the Agogomé community.',
    'gallery.food_agogome.description': 'Food distribution supporting vulnerable children and families in Agogomé.',
    'gallery.food_notse.description': 'Food distribution supporting vulnerable people and families in Notsé.',
    'gallery.photos': 'photos',
    'gallery.photo': 'photo',
    'gallery.of': 'of',
    'gallery.category.all': 'All categories',
    'gallery.category.activities': 'Activities',
    'gallery.category.school_kits': 'School kits',
    'gallery.category.food_aid': 'Food aid',
    'gallery.category.activities.description': 'Educational and community activities that help children learn, create and grow together.',
    'gallery.category.school_kits.description': 'School-supply distributions that support children and families at the start of the school year.',
    'gallery.category.food_aid.description': 'Food-aid actions serving children, vulnerable people and families in local communities.',
    'gallery.hero.label': 'Featured gallery categories',
    'gallery.hero.previous': 'Previous category',
    'gallery.hero.next': 'Next category',
    'gallery.hero.slides': 'Choose a gallery category',
    'gallery.hero.show': 'Show',
    'gallery.search.label': 'Search gallery images',
    'gallery.search.placeholder': 'Search by name, place, category or date…',
    'gallery.filter.category': 'Filter by category',
    'gallery.filters.reset': 'Reset filters',
    'gallery.explorer.eyebrow': 'Photo archive',
    'gallery.explorer.title': 'Explore our actions',
    'gallery.results': 'images found',
    'gallery.empty.title': 'No image found',
    'gallery.empty.description': 'Try another search or reset the active filters.',
    'gallery.loading_more': 'Loading more images…',
    'gallery.open': 'Open',
    'gallery.modal.previous': 'Previous image',
    'gallery.modal.next': 'Next image',
    'gallery.modal.location': 'Location',
    'gallery.modal.date': 'Date',
  ...
  fr: {
    ...
    'gallery.mini_camp.description': 'Activités éducatives, créatives et communautaires proposées aux enfants et adolescents pendant le Mini Camp d’Agogomé.',
    'gallery.school_kits_davie.description': 'Distribution de kits scolaires pour accompagner les enfants et les familles à l’approche de la rentrée.',
    'gallery.school_kits_agogome.description': 'Distribution de fournitures scolaires organisée pour les enfants de la communauté d’Agogomé.',
    'gallery.food_agogome.description': 'Distribution de vivres au profit des enfants et familles vulnérables d’Agogomé.',
    'gallery.food_notse.description': 'Distribution de vivres au profit des personnes et familles vulnérables de Notsé.',
    'gallery.photos': 'photos',
    'gallery.photo': 'photo',
    'gallery.of': 'sur',
    'gallery.category.all': 'Toutes les catégories',
    'gallery.category.activities': 'Activités',
    'gallery.category.school_kits': 'Kits scolaires',
    'gallery.category.food_aid': 'Aide alimentaire',
    'gallery.category.activities.description': 'Des activités éducatives et communautaires qui permettent aux enfants d’apprendre, de créer et de grandir ensemble.',
    'gallery.category.school_kits.description': 'Des distributions de fournitures scolaires qui accompagnent les enfants et les familles à la rentrée.',
    'gallery.category.food_aid.description': 'Des actions d’aide alimentaire au service des enfants, des personnes vulnérables et des familles.',
    'gallery.hero.label': 'Catégories mises en avant dans la galerie',
    'gallery.hero.previous': 'Catégorie précédente',
    'gallery.hero.next': 'Catégorie suivante',
    'gallery.hero.slides': 'Choisir une catégorie de galerie',
    'gallery.hero.show': 'Afficher',
    'gallery.search.label': 'Rechercher des images dans la galerie',
    'gallery.search.placeholder': 'Rechercher par nom, lieu, catégorie ou date…',
    'gallery.filter.category': 'Filtrer par catégorie',
    'gallery.filters.reset': 'Réinitialiser les filtres',
    'gallery.explorer.eyebrow': 'Archives photographiques',
    'gallery.explorer.title': 'Explorez nos actions',
    'gallery.results': 'images trouvées',
    'gallery.empty.title': 'Aucune image trouvée',
    'gallery.empty.description': 'Essayez une autre recherche ou réinitialisez les filtres actifs.',
    'gallery.loading_more': 'Chargement d’images supplémentaires…',
    'gallery.open': 'Ouvrir',
    'gallery.modal.previous': 'Image précédente',
    'gallery.modal.next': 'Image suivante',
    'gallery.modal.location': 'Lieu',
    'gallery.modal.date': 'Date',
