...
export const projectSprints: TrackerSprint[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { id: "deployment-strategy", title: "Stratégie de déploiement", description: "Choisir et documenter GitHub Pages, Firebase App Hosting ou une autre cible.", status: "in-progress", progress: 85, priority: "high", evidence: "GitHub Pages est la cible publique du frontend statique; le workflow active Pages, construit avec le sous-chemin exact /FSF_Co et déploie main. Firebase reste réservé à une future décision backend.", acceptanceCriteria: ["Cible officielle choisie", "Déploiement GitHub Pages et ressources statiques vérifiés", "Rollback documenté", "Environnements preview et production"] },
