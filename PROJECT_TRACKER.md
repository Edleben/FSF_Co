...
- GitHub Pages est la cible publique du frontend statique; Firebase App Hosting reste présent uniquement comme piste pour une future architecture backend à clarifier.
